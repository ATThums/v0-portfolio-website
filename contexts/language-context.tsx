...
const translations = {
  ...
  en: {
    ...
    "hero.subtitle": "Creating interactive digital experiences",
    ...
    "about.description":
      "Digital Game Developer graduated from the University of Caxias do Sul (UCS), with experience in Unity, Unreal, programming and software modeling. I am a former military, which consolidated skills in discipline, leadership, teamwork and resilience. Currently working at WMC Tecnologia, providing technical and functional support for ERP systems and Android platforms, focusing on analysis, improvements and usability. Participated in two editions of Game Jam Plus, in 2022, winning 1st place regionally with the game Dodge Circle. I am passionate about technology, creativity, games and innovation, always seeking continuous learning and new challenges.",
    ...
    "skills.yearsExp": "Years of Experience",
    "skills.projectsCompleted": "Completed Projects",
    "skills.gamesPublished": "Published Games",
    ...
    "gallery.featured": "Featured Works",
    "gallery.allArtworks": "Images",
    ...
    "gallery.prompt": "Prompt",
    "gallery.model": "Model",
    "gallery.totalArtworks": "Total Works",
